<nav class="navbar  bg-primary fixed-top" data-bs-theme="dark" style="display:<?php
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="http://localhost/projeto_php/">Sistema de gerenciamento</a>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="http://localhost/projeto_php/">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/projeto_php/fornecedor">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/projeto_php/cliente">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/projeto_php/venda">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/projeto_php/compra">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/projeto_php/produto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="#" onclick="sair()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-6a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h6A1.5 1.5 0 0 0 14 12.5v-9A1.5 1.5 0 0 0 12.5 2h-6A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z" />
                                <path fill-rule="evenodd" d="M3.854 8.354a.5.5 0 0 1 0-.708L6.293 5H1.5a.5.5 0 0 1 0-1h4.793L3.854 1.354a.5.5 0 1 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708 0z" />
                            </svg> Sair
                        </a>
