        ...
        <div class="">
            ...
            <div class="d-flex  gap-2">
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" value="Mark" placeholder="000.000.000.00" minlength="14" maxlength="14" required>
            ...
            <div class="d-flex  gap-2">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="number" class="form-control" min="0" id="validationCustom02" value="Otto" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                </div>
                <div class="col-sm-2">
                    ...
                    <input type="number" class="form-control" min="0" id="validationCustom02" disabled value="Otto" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                </div>
